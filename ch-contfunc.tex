...
\begin{exercise}
Prove o \corref{fconstineq:cor}.
\end{exercise}

\begin{exercise}
Prove o \corref{fsqueeze:cor}.
\end{exercise}

\begin{exercise}
Prove o \corref{falg:cor}.
\end{exercise}
...
Let $A \subset S$.  Suponha que $c$ é um ponto de acumulação de $A$ and
it is also a cluster point of $S$.
Let $f \colon S \to \R$ be a function.  Mostre que if
...
Seja $c_1$ seja um ponto de acumulação de $A \subset \R$ and $c_2$ be
a cluster point of $B \subset \R$.  Suponha que 
...
sequência $\{x_n\}_{n=1}^\infty$ in $\R$, the sequence
...
Prove a seguinte versão mais forte de uma das implicações do
\lemmaref{seqflimit:lemma}:
Let $S \subset \R$, $c$ seja um ponto de acumulação de $S$, and $f \colon S \to
\R$ be a function.
Suponha que that for every sequence $\{x_n\}_{n=1}^\infty$ in $S \setminus \{c\}$ tais que
$\lim_{n\to\infty} x_n = c$ the sequence $\bigl\{ f(x_n) \bigr\}_{n=1}^\infty$ seja convergente.
Mostre então que existe o limite de $f(x)$ quando $x \to c$.
\end{exercise}

\begin{exercise}
Prove a \propref{prop:onesidedlimits}.
\end{exercise}

\begin{exercise}
Suponha que $S \subset \R$ and $c$ é um ponto de acumulação de $S$.  Suponha que $f \colon
S \to \R$ seja limitada.  Mostre que there exists a sequence
$\{ x_n \}_{n=1}^\infty$
with $x_n \in S \setminus \{ c \}$ and $\lim_{n\to\infty} x_n = c$ tais que
...
and $g$ tais que $f(x) \to c_2$ as $x \to c_1$ and
$g(y) \to L$ as $y \to c_2$, but $g\bigl(f(x)\bigr)$ não tenda a $L$
as $x \to c_1$.
\end{exercise}
