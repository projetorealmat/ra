...
\hypersetup{
    ...
    pdfkeywords={análise real, integral de Riemann, derivada, limite, sequência},
    pdfsubject={Análise real},
    pdftitle={An\'alise B\'asica: Introdu\c{c}\~ao \`a An\'alise Real},
    pdfauthor={Jiri Lebl}
}
...
\newcommand{\sectionnotes}[1]{\noindent \emph{Nota: #1} \medskip \par}
...
\title{An\'alise B\'asica: Introdu\c{c}\~ao \`a An\'alise Real}
...
\theoremstyle{remark}
\newtheorem{remark}[thm]{Observa\c{c}\~ao}

\theoremstyle{definition}
\newtheorem{defn}[thm]{Defini\c{c}\~ao}
...
\newtheorem{exercise}{Exerc\'{\i}cio}[section]
...
\theoremstyle{example}
\newtheorem{example}[thm]{Exemplo}

% referencing
\newcommand{\figureref}[1]{\hyperref[#1]{Figura~\ref*{#1}}}
\newcommand{\tableref}[1]{\hyperref[#1]{Tabela~\ref*{#1}}}
\newcommand{\chapterref}[1]{\hyperref[#1]{cap\'{\i}tulo~\ref*{#1}}}
\newcommand{\Chapterref}[1]{\hyperref[#1]{Cap\'{\i}tulo~\ref*{#1}}}
\newcommand{\sectionref}[1]{\hyperref[#1]{\S\ref*{#1}}}
\newcommand{\exerciseref}[1]{\hyperref[#1]{Exerc\'{\i}cio~\ref*{#1}}}
\newcommand{\remarkref}[1]{\hyperref[#1]{Observa\c{c}\~ao~\ref*{#1}}}
\newcommand{\exampleref}[1]{\hyperref[#1]{Exemplo~\ref*{#1}}}
\newcommand{\thmref}[1]{\hyperref[#1]{Teorema~\ref*{#1}}}
\newcommand{\propref}[1]{\hyperref[#1]{Proposi\c{c}\~ao~\ref*{#1}}}
\newcommand{\lemmaref}[1]{\hyperref[#1]{Lema~\ref*{#1}}}
\newcommand{\corref}[1]{\hyperref[#1]{Corol\'ario~\ref*{#1}}}
\newcommand{\defnref}[1]{\hyperref[#1]{Defini\c{c}\~ao~\ref*{#1}}}
...
\flushright
{\Huge\bfseries \sffamily An\'alise B\'asica I }
\noindent\rule[-1ex]{\textwidth}{5pt}\\[2.5ex]
\hfill\emph{\Large \sffamily Introdu\c{c}\~ao \`a An\'alise Real, Volume I}
\end{minipage}}
...
\flushright
{\bfseries
Autor: Ji{\v r}\'i Lebl\\[1.5ex]
Tradução para o português brasileiro\\[0.5ex]
Carlos André Duarte Costa\\[1ex]}
...
\noindent
Direitos autorais \copyright 2009--2026 Ji{\v r}\'i Lebl
...
\noindent
\myincludegraphics[width=1.38in]{license}{Logotipo da licença CC BY-NC-SA}
\quad
\myincludegraphics[width=1.38in]{license2}{Logotipo da licença CC BY-SA}
...
é distribuída sob duas licenças Creative Commons:
Atribuição-NãoComercial-CompartilhaIgual 4.0 Internacional e
Atribuição-CompartilhaIgual 4.0 Internacional.
Para consultar uma cópia dessas licenças, acesse
...
\noindent
Você pode usar, imprimir, duplicar e compartilhar este livro à vontade. Pode
elaborar suas próprias notas com base nele e reutilizar partes, desde que
mantenha a mesma licença. Você pode considerar que a licença é CC-BY-NC-SA ou
CC-BY-SA, conforme aquela que for compatível com o uso pretendido.
Sua obra derivada deve adotar pelo menos uma dessas licenças.
Obras derivadas devem ser identificadas de forma destacada como tais.
%PRINT
% not for lulu
%}
...
\noindent
Direitos autorais \copyright 2026 Carlos André Duarte Costa (tradução para o português brasileiro).

\bigskip

\noindent
\textbf{Créditos da edição brasileira.}
Tradução do Volume I: Carlos André Duarte Costa.
Revisão editorial: equipe de revisão da edição brasileira.
O Volume II, disponível na versão HTML, permanece em inglês.



\noindent
Durante a elaboração deste livro, o autor recebeu apoio parcial dos auxílios
NSF DMS-0900885 e DMS-1362337.

\bigskip

\noindent
A versão/edição principal só aumenta quando há mudanças substanciais.
A partir da 6ª edição, os dois volumes compartilham o mesmo número de versão.
O registro das edições começou pela edição 4, isto é, pela versão 4.0, pois
não havia registro das edições anteriores.  %The edition given with the ISBN number is the major version.

\bigskip

\noindent
Consulte \url{https://www.jirka.org/ra/} ou
\url{https://jirilebl.github.io/ra/} para obter mais informações, incluindo
formas de contato, possíveis atualizações e erratas.
...
\noindent
O código-fonte \LaTeX\ do livro está disponível para possíveis modificações e
personalizações no GitHub: \url{https://github.com/jirilebl/ra}
%PRINT
% not for lulu
%}
...
\thispagestyle{empty}
\begin{center}
{\Large\bfseries Créditos do projeto REALMat}
\end{center}
...
\smallskip
\noindent
Portal: \url{https://projetorealmat.github.io/}.

\noindent
Repositório desta edição: \url{https://github.com/projetorealmat/ra}.

\noindent
Fonte original: \url{https://github.com/jirilebl/ra}.
...
\cleardoublepage  
\phantomsection
\addcontentsline{toc}{chapter}{Leituras complementares}
\markboth{LEITURAS COMPLEMENTARES}{LEITURAS COMPLEMENTARES}
\begin{bibchapter}[Leituras complementares]
\begin{biblist}[\normalsize]
...
\bib{GIAM}{misc}{
   ...
   note={Disponível em \url{http://giam.southernct.edu/GIAM/}},
}

\bib{Hammack}{misc}{
   author={Hammack, Richard},
   title={Book of Proof},
   note={Disponível em \url{https://richardhammack.github.io/BookOfProof/}},
}

\bib{Rosenlicht}{book}{
   author={Rosenlicht, Maxwell},
   title={Introduction to Analysis},
   note={Reimpressão da edição de 1968},
...
\begingroup
\renewcommand{\pagelistname}{P\'agina}
...
\renewenvironment{theglossary}%
  {\setlength\cellspacetoplimit{4pt}
   ...
   \markboth{LISTA DE NOTA\c{C}\~OES}{LISTA DE NOTA\c{C}\~OES}
   \begin{longtable}{Sl @{\extracolsep{\fill}} Sl @{\extracolsep{\fill}} Sl}}%
  {\end{longtable}}%
\cleardoublepage
\microtypesetup{protrusion=false}
\printglossary[title=Lista de nota\c{c}\~oes]
\microtypesetup{protrusion=true}
\endgroup
